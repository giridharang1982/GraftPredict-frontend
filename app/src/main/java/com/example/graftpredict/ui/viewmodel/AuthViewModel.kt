package com.example.graftpredict.ui.viewmodel
...
class AuthViewModel(private val repo: AuthRepository, private val sessionManager: SessionManager) : ViewModel() {
    ...
    fun login(email: String, password: String) {
        viewModelScope.launch {
            ...
            if (res.isSuccess) {
                ...
                _state.value = UiState.Error(res.exceptionOrNull()?.message ?: "Login failed")
            }
        }
    }
    ...
    fun sendForgotOtp(email: String) {
        viewModelScope.launch {
            ...
            if (res.isSuccess) {
                ...
                _state.value = UiState.Error(res.exceptionOrNull()?.message ?: "Failed to send OTP")
            }
        }
    }
    ...
    fun verifyForgotOtp(email: String, otp: String) {
        viewModelScope.launch {
            ...
            if (res.isSuccess) {
                ...
                _state.value = UiState.Error(res.exceptionOrNull()?.message ?: "OTP verification failed")
            }
        }
    }
    ...
    fun resetPassword(email: String, newPassword: String) {
        viewModelScope.launch {
            ...
            if (res.isSuccess) {
                ...
                _state.value = UiState.Error(res.exceptionOrNull()?.message ?: "Reset failed")
            }
        }
    }
    ...
    fun signup(firstName: String, lastName: String, email: String, password: String, otp: String) {
        viewModelScope.launch {
            _state.value = UiState.Loading
            val res = repo.signup(
                com.example.graftpredict.data.models.SignUpRequest(
            ...
            if (res.isSuccess) {
                ...
                _state.value = UiState.Error(res.exceptionOrNull()?.message ?: "Signup failed")
            }
        }
    }
    ...
    fun signupWithDetails(firstName: String, lastName: String, email: String, password: String, dateOfBirth: String, gender: String, otp: String) {
        viewModelScope.launch {
            ...
            val res = repo.signupWithDetails(
                com.example.graftpredict.data.models.SignUpWithDetailsRequest(
                    first_name = firstName,
                    last_name = lastName,
                    email = email,
                    password = password,
